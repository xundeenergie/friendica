...
| context-id | [item-uri](help/spec/database/db_item-uri) | id |
| conversation-id | [item-uri](help/spec/database/db_item-uri) | id |
...
| post-user-id | [post-user](help/spec/database/db_post-user) | id |
