...
|-------|--------------|--------------|
| notify-id | [notify](help/spec/database/db_notify) | id |
| master-parent-uri-id | [item-uri](help/spec/database/db_item-uri) | id |
| receiver-uid | [user](help/spec/database/db_user) | uid |
